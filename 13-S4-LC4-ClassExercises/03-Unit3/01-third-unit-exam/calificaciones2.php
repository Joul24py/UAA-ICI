                ...
                <form ACTION="guardar_datos.php" METHOD="POST">
                    ...
                    <div class="campos">
                        ...
                        <div class="Campo">
                            ...
                            <input type="number" name="p1" min="0" max="10" placeholder="Calificación" >
                        </div>

                        <div class="Campo">
                            <label for="parcial2">Segundo Parcial:</label>
                            <input type="number" name="p2" min="0" max="10" placeholder="Calificación" >
                        </div>

                        <div class="Campo">
                            <label for="parcial3">Tercer Parcial:</label>
                            <input type="number" name="p3" min="0" max="10" placeholder="Calificación" >
                        </div>

                        <div class="Campo">
                            <label for="proyecto">Proyecto:</label>
                                <input type="number" name="pro" min="0" max="10" placeholder="Calificación" >
                        </div>

                        <div class="Campo tareas">
                            <label for="tareas">Tareas:</label>
                            <input type="number" name="tar" min="0" max="10" placeholder="Calificación">
                        </div>

                        <div class="Campo">
                            <label for="faltas">Faltas:</label>
                            <input type="text" name="falt" id="faltas" placeholder="Número de faltas" onkeypress='return validaNumericos(event)'/>            
                        </div>
                    ...
                    <div class="letra-color">
                        ...
                        <div class="contenedor-tabla">
                            ...
                            $datos=$_POST;
                                ...
                                $query2="SELECT lista, nombre, apellido_materno, apellido_paterno, calificacion_final FROM calificaciones where calificacion_final<6.5 order by lista asc"; //CAMBIO
                                $resultado2=$mysqli->query($query2); //CAMBIO
                                $query3="SELECT lista, nombre, apellido_materno, apellido_paterno, faltas FROM calificaciones where faltas>16 order by lista asc"; //CAMBIO
                                $resultado3=$mysqli->query($query3); //CAMBIO
                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a  class="btn-editar btn2" href="editar.php?id=<?php echo $row['lista'];?>">Editar</a>
                                                 ...
                                                 <button type="button" id="borrar"class="btn-borrar btn2" >Borrar</button>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
